...
REGISTRY = {cls.name: cls for cls in (MACrossover, CostAwareMomentum, Lag1Reversal, TSMom, DonchianBreakout, TrendFilter, DowSeasonality, VolRegime, HalvingClock, CascadeWarning, EVaRRegime, MultiscaleMove)}
